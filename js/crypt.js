...
const outcome3 = "There is a peculiar tome clutched in the hands of one of the corpses. You wrest it out of its hands and find that it's in surprisingly good condition. It appears to be some sort of pagan manuscript. As you read out loud some of the text, a chill crawls down your throat. A mailicious entity has claimed your soul.";
const outcome4 = "It is impossible to count all the dead in the crypt. They have all led different lives, but only in death have they all become equals. As you are pondering death, you fall into a deep pit and break both your legs.";
...
const outcome7 = "You walk into a chamber that appears to be a long-forgotten dungeon. The cracked floor is stained brown with the blood of countless past convicts and inoccents. Lonely skeletons are still shackled to the walls in isolated cells. You enter a cell for no reason, then the door slams shut behind you. Locked. The horror dawns on you as no one will hear your screams, and you will never see the light of another day.";
const outcome8 = "You trip on a skull and are rendered unconcious when you hit the ground. You die from internal bleeding.";
const outcome9 = "You walk into an ornate room with a chest sitting in the center. You open the chest and...there's nothing inside it. You walk away in dissapointed.";
const outcome10 = "You enter an inconspicuous room with a casket in its center. Upon opening the casket, you're startled when a skeletal hand snatches your arm and pulls you inside with the lid shutting closed behind. Welcome home.";
